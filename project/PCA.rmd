...
```{r eval = TRUE, echo = FALSE, results='hide', message = FALSE, warning=FALSE, fig.align = "center", fig.pos='htb!', fig.cap = 'Simulation without setting the number of components'}
...
```{r eval = TRUE, echo = FALSE, results='hide', message = FALSE, warning=FALSE, fig.align = "center", fig.pos='htb!', fig.cap = 'Simulation with setting the number of components to 6'}
