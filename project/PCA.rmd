...
```
<!-- [\textcolor{blue}{J. Groen, G. Kapetanios (2008)}](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=1136165) -->
<!-- [\textcolor{blue}{Stock and Watson (2009)}](https://scholar.harvard.edu/stock/publications/forecasting-dynamic-factor-models-subject-structural-instability) -->
# Introduction
...
predict_by_sample <- function(sample_name, sample, sample_start_date, sample_name_short){
  ...
  for (i in 1:runs) {
    ...
    for (j in application$PCR_ncomp) {
      ...
      # plot(prediction_sample[, "LHUR"], main = "LHUR sub-sample")
      # lines(pcr$LHUR[[sample_name]]$predicted)
